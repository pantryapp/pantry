(function() {
  ...
  angular.module('store').directive('optionsMenu', optionsMenu);

  function optionsMenu() {
    return {
      restrict: 'E',
      templateUrl: '/views/templates/options-menu.html',
      link: linkFunc
    }
  }
...
/* Here is the code for the gooey menu. 
 * Adapt it for the linkFunc
