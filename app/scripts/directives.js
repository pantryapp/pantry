...
directives.directive('pantryItems', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/pantry-list.html',
...
directives.directive('pantryItem', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/pantry-item.html'
		}
	});
directives.directive('pantryItemOptions', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/pantry-item-options.html'
		}
	});
...
directives.directive('groceryItemOptions', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/grocery-item-options.html'
		}
	});
directives.directive('receipeList', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/receipe-list.html',
...
directives.directive('receipeOptions', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/receipe-options.html'
		}
	});
directives.directive('receipeIngredientOptions', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/receipe-ingredient-options.html'
		}
	});
directives.directive('itemFilter', function(){
		return{
			restrict: 'E',
			templateUrl: 'views/item-filter.html',
